...
import arlLogoWhite from "@public/arl-logo-white.svg"; // Import the new logo
...
function Header() {
  return (
    <header className="flex flex-col items-center mb-20 md:mb-20">
      <Image
        src={arlLogoWhite} // Use the new logo
        alt="ARL Logo" // Change the alt text to reflect the new logo
      ...
      <h1 className="text-2xl md:text-6xl font-semibold md:font-bold tracking-tighter mb-6 text-zinc-100">
        ...
        <span className="inline-block text-blue-500"> Race! </span>
      </h1>
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-3 justify-center">
      <MenuItem
        ...
        href="/gasless"
        description="Execute transactions without having to hold ETH."
      />
      <MenuItem
        title="Pay"
        href="/pay"
